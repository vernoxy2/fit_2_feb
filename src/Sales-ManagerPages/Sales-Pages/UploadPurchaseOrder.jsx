...
export default function UploadPurchaseOrder() {
 ...
 const handleSubmit = async () => {
  setUploading(true);
  try {
    await addToStock(items, workOrder.woNumber, workOrder.customer);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-0.5">Upload Excel file to create purchase order and reserve stock</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            ...
            <div className="p-6 space-y-4">
              <Input label="PO Number" value={workOrder.woNumber} onChange={(e) => setWorkOrder({ ...workOrder, woNumber: e.target.value })} placeholder="WO-2024-001" required />
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-end gap-3">
            ...
            <BtnPrimary onClick={handleSubmit} disabled={uploading}>
              {uploading ? "Saving to Firebase..." : "Create Work Order →"}
            </BtnPrimary>
          </div>
        </div>
      )}
