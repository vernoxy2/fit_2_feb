...
import { getSalesStats, WORK_ORDERS_ENHANCED, PURCHASE_ORDERS_ENHANCED, NOTIFICATIONS_ENHANCED, CHALLANS_ENHANCED } from "../data/salesEnhancedData";
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button className="flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white text-xs font-bold rounded-lg hover:bg-indigo-700 transition-colors">
          <FiFileText size={14} /> Create Work Order
        </button>
      </div>
